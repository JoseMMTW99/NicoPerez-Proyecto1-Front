            ...
            {edificio ? (
                <>
                    <div className='container-fluid p-0'>
                        <div className='divBotonVolverAtras mt-4 ms-4 d-flex justify-content-center'>
                            <a href='/Administracion'>
                                <button className="botonAgregarEdificio px-4">
                                    <i className="bi bi-arrow-left-short"></i>
                                </button>
                            </a>
                            <h1 className='text-center mb-3 text-white tituloEdificio mx-auto'>{edificioName}</h1>
                        </div>
                    </div>
